      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Selamat datang kembali! Berikut ringkasan performa toko Anda hari
            ini.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        <Card className="border-none shadow-xl bg-white/50 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>
              Grafik pendapatan bulanan sepanjang tahun ini
            </CardDescription>
          </CardHeader>
          <CardContent>
    ...
    <Card className="border-none shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden bg-white group">
      <CardContent className="p-6">
        <div className="flex items-center justify-between">
          ...
          {trend && (
            <div
              className={`text-xs font-bold px-2 py-1 rounded-full ${trend === "up" ? "text-emerald-600 bg-emerald-50" : "text-rose-600 bg-rose-50"}`}
            >
              {trend === "up" ? "↑" : "↓"}
            </div>
          )}
