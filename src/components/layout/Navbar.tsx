        ...
        <>
            ...
            <nav className="fixed bottom-0 left-0 z-50 w-full border-t border-border bg-card md:hidden shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
                <div className="flex h-[60px] items-center justify-around px-2">
                    ...
                    <Link href="/categories" className="flex flex-col items-center justify-center gap-1 text-muted-foreground hover:text-primary transition-colors">
                        <FiGrid size={20} />
                        <span className="text-[10px] font-medium">Kategori</span>
                    </Link>

                    <Link href="/cart" className="relative flex flex-col items-center justify-center gap-1 text-muted-foreground hover:text-primary transition-colors">
